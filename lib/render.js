...
module.exports = function (html, options) {
  ...
  // Allow to pass a custom instance of markdown-it. This allows the use of custom
  // markdown-it plugins and options, but bypasses marky-markdown highlighting 
  var renderer = options.renderer || MD(mdOptions)
